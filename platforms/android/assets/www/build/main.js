...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__details_detail_detail__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__details_detail2_detail2__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__details_detail3_detail3__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__details_detail4_detail4__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__details_more_menu_info_list_more_menu_info_list__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__details_more_menu_info_chart_more_menu_info_chart__ = __webpack_require__(114);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var InfoPage = (function () {
    ...
    InfoPage.prototype.openDetailPage = function (item) {
        switch (item.num) {
            case "1":
                this.nav.push(__WEBPACK_IMPORTED_MODULE_3__details_detail_detail__["a" /* DetailPage */], { item: item });
                break;
            case "2":
                this.nav.push(__WEBPACK_IMPORTED_MODULE_4__details_detail2_detail2__["a" /* Detail2Page */], { item: item });
                break;
            case "3":
                this.nav.push(__WEBPACK_IMPORTED_MODULE_5__details_detail3_detail3__["a" /* Detail3Page */], { item: item });
                break;
            case "4":
                this.nav.push(__WEBPACK_IMPORTED_MODULE_6__details_detail4_detail4__["a" /* Detail4Page */], { item: item });
                break;
            case "5":
            ...
            case "6":
                ...
                break;
            case "7":
                this.nav.push(__WEBPACK_IMPORTED_MODULE_8__details_more_menu_info_chart_more_menu_info_chart__["a" /* MoreMenuInfoChartPage */], { item: item });
                break;
        }
    };
    return InfoPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_map_map__ = __webpack_require__(285);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_in_app_browser__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_http__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_place_place__ = __webpack_require__(211);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_tabs_tabs__ = __webpack_require__(212);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_place_place__ = __webpack_require__(211);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MrResultProvider = (function () {
    ...
    MrResultProvider.prototype.getMRJobResultWithURL = function () {
        var url = 'http://210.114.91.91:22893/json/mr-result/with-url';
        return this.http.get(url);
    };
